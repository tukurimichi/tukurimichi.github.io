...
var SPENDS = [
  ...
  { date:"2026.08.23", ja:"Kling AI（動画生成）Standardの初月。無料枠では30秒の動画が組めないため。決めたルールの「1回1,000円まで」を271円超えた。あとで調べたら、この額で作れるのは月11本＝1本あたり約120円だった（→<a href='credit.html'>1,271円の失敗</a>）", en:"Kling AI (video generation), first month of Standard — the free tier could not build a 30-second piece. This is ¥271 over our own ¥1,000-per-spend rule. Checking afterwards, this buys 11 clips a month, about ¥120 each (see <a href='credit.html'>A ¥1,271 Mistake</a>)", out:1271, in:0 }
];
